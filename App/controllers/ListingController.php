...
class ListingController
{
  ...
  public function store()
  {
    ...
    // return only keys that match both keys from $_POST array and values from allowed fields array
  ...
  public function search()
  {
    ...
    $query = "SELECT * FROM listings WHERE (title LIKE :keywords OR description LIKE :keywords OR tags LIKE :keywords OR company LIKE :keywords OR requirements LIKE :keywords) AND (city LIKE :location OR state LIKE :location)";
